...
(function () {
  ...
  var SCHEMA = {
    ...
    cross_device_teaser_viewed:    [],
    cross_device_request_opened:   ["cta_location"],
    cross_device_request_closed:   ["cta_location", "via"],
    cross_device_request_invalid:  ["reason"],
    cross_device_request_submitted:["cta_location"],
